...
def dagger():
    return Object(algebra.Location(0, 0), '-', 'dagger', libtcod.sky,
                  ...
                  equipment=Equipment(slot='right hand', strength_bonus=2))
...
def paralyzation_scroll(pos=algebra.Location(0, 0)):
    return Object(pos, '#', 'scroll of paralyzation', libtcod.red,
                  item=Item(use_function=spells.cast_paralyze,
                            description='Reading these runes will paralyze the creature you focus on for short time.'))
...
def sword(pos=algebra.Location(0, 0)):
    return Object(pos, '/', 'sword', libtcod.sky,
                  ...
                  equipment=Equipment(slot='right hand', strength_bonus=3))
