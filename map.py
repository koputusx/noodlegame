...
terrain_types = [
        Terrain('wall', 'wall', '#', libtcod.Color(95, 95, 95),
                libtcod.Color(95, 95, 95), True, True),
        Terrain('ground', 'ground', '.', libtcod.Color(127, 127, 127),
                libtcod.Color(127, 127, 127), False, False)
                ]
